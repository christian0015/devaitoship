    ...
    function initWidget() {
      ...
      async function fetchShopData(){
        try{
          ...
          console.log("Products: ",data.shop);
      ...
      function getToAddress(){
        ...
        if (isCartOrCheckoutPage()) {
          ...
          return {
            ...
            country: mapCountryIdToCode(formData.country) // Mapping du code pays
          };
        } else {
          ...
          return {
            ...
            country: "FR" // Pays fixé à France comme demandé
          };
        }
      }
      ...
      function prepareRequests(){
        ...
        products.forEach(function(prod){
          ...
          // Pour chaque produit, créer un colis par unité (Shippo préfère les colis individuels)
          for(let i = 0; i < prod.quantity; i++) {
            // Formater le colis selon le format attendu par Shippo
            const parcel = {
